...
@include('main.about_component.about_accomplishments')
@include('main.about_component.about_team')
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/main/about_component/about_team.css') }}">
    <link rel="stylesheet" href="{{ asset('css/main/about_component/about_accomplishments.css') }}">
</head>
<body>
    <div>
        @yield('header')
