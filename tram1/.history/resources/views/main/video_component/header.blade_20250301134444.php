...
<div class="header1">
    <span class="header1_socials">
        <a href="https://web.facebook.com/profile.php?id=61572457065456"><img src="{{ asset('images/facebook_header.png') }}" class="header_socials_facebook" alt=""></a>
        ...
        <a href="https://www.instagram.com/tramnews2025/"><img src="{{ asset('images/instagram_header.png') }}" class="header_socials_facebook" alt=""></a>
...
<div class="header2">
    ...
    <span class="header2_links">
        ...
        <table class="header2_menu_table">
            ...
            <tr><td><a href="{{ route('videos') }}" class="header2_links_table_main_td a_general_header2_menu">Videos</a></td></tr>
            <tr><td><a href="{{ route('news') }}" class="a_general_header2_menu">News</a></td></tr>
            <tr><td><a href="{{ route('about') }}" class="a_general_header2_menu">About Us</a></td></tr>
            <tr><td><a href="{{ route('contact') }}" class="a_general_header2_menu">Contact Us</a></td></tr>
        </table>
    ...
    <span class="header2_search_button">
        ...
        <button class="header2_button" 
        onclick="window.location.href='{{ route('signin') }}'">Advertise With Us</button>
    </span>
</div>
