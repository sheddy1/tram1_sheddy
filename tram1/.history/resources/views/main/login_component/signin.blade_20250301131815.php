...
<div class="login">
            ...
            <span class="login_image_span_header">
                <span class="login_image_span_header1">
                    ...
                    <span class="login_image_span_header1_name">
                        <a href="{{ route('welcome') }}" style="text-decoration: none; color:#EC3237">
                ...
                <span class="login_image_span_header1">
                    ...
                    onclick="window.location.href='{{ route('signin') }}'">Sisasasgn up</button>
                </span>
            </span>
        </span>
    ...
    <span class="login_main">
        <span class="login_main_header">
            ...
            <span class="login_main_header1">
                <button class="login_image_span_header1_button3">Log In</button>

                <button class="login_image_span_header1_button2">Sign up</button>
            </span>
        </span>
